...
tme = Button(tk, text='Time:00:30', font='Times 10 bold', bg='black', fg='white', height=4, width=10, command=None)
tme.grid(row=6, column=0)

res = Button(tk, text='Restart', font='Times 10 bold', bg='black', fg='white', height=4, width=10, command=lambda: None)
res.grid(row=6, column=1)

qui = Button(tk, text='Quit', font='Times 10 bold', bg='black', fg='white', height=4, width=10, command=tk.destroy)
qui.grid(row=6, column=2)
